...
console.log("El libro fue escrito por el autor $(libro.autor) en el año $(libro.year)");
...
// Crear un array llamado 'Pokemones' con al menos 10 Especies
let Pokemones = ["Bicho", "Dragón", "Eléctrico", "Hada", "Lucha", "Fuego", "Volador", "Fantasma", "Tierra", "Agua"];
